...
<body>
    <div class="signup-form">
        ...
        <h2><?= $title ?></h2>
        <p class="lead">Please fill the form below to edit your profile</p>
        <!-- FUll Name -->
        ...
        <div class="form-group">
            <div class="input-group">
                ...
                <input type="text" class="form-control" id="email" name="email" placeholder="Email Address" value="<?= $user['email'] ?>" readonly>
